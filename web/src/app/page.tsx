  ...
  return (
    <div className="min-h-dvh" style={{ backgroundColor: "var(--color-bg)" }}>
      ...
      <main id="main-content">
        ...
        {/* ── ① Hero ─────────────────────────────── */}
        <section
          className="py-16 px-4 sm:py-20 sm:px-6 text-center"
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <Link
              href="/signup"
              className="inline-flex items-center justify-center px-8 sm:px-10 py-4 rounded-xl text-white font-semibold transition-colors cursor-pointer"
              style={{ backgroundColor: "var(--color-cta)", fontSize: "1rem" }}
        ...
        {/* ── ② 이용방법 ──────────────────────────── */}
        <section
          className="py-16 px-4 sm:py-20 sm:px-6"
        ...
        >
          <div className="max-w-5xl mx-auto">
            ...
            {/* Steps — 모바일: 세로 타임라인 / 데스크톱: 3열 */}
            <div className="flex flex-col sm:grid sm:grid-cols-3 gap-0 sm:gap-8">
              {steps.map((s, idx) => (
                <div key={s.num} className="relative">
                  ...
                  {idx < steps.length - 1 && (
                    <div
                      className="sm:hidden absolute left-[1.9rem] top-20 w-0.5 h-8"
                      style={{ backgroundColor: "var(--color-border)" }}
                      aria-hidden="true"
                    />
                  )}

                  <div className="flex sm:flex-col sm:items-center sm:text-center items-start gap-4 sm:gap-0 pb-8 sm:pb-0">
                    {/* 아이콘 박스 */}
                    <div
                      className="shrink-0 w-16 h-16 sm:w-20 sm:h-20 rounded-2xl flex items-center justify-center sm:mb-4"
                      style={{ backgroundColor: "var(--color-primary-soft)", color: "var(--color-primary)" }}
                      role="img"
                      aria-label={s.label}
                    >
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {features.map((f) => (
                <div
                  key={f.title}
                  className="flex items-start gap-4 p-5 sm:p-6 rounded-2xl border transition-shadow hover:shadow-sm"
      ...
      <footer style={{ backgroundColor: "#0F172A" }}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-12 flex flex-col sm:flex-row justify-between gap-8">
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: "#94A3B8" }}>AI 복약 가이드 서비스</p>
          </div>

          <div>
            <p className="font-semibold mb-2 text-white text-sm">고객지원</p>
            <p className="text-sm" style={{ color: "#94A3B8" }}>전화: 000-000-0000</p>
            <p className="text-sm" style={{ color: "#94A3B8" }}>이메일: support@sullivan.com</p>
          </div>

          <div>
            <p className="font-semibold mb-2 text-white text-sm">법적 고지 안내</p>
            <p className="text-sm cursor-pointer hover:text-white transition-colors" style={{ color: "#94A3B8" }}>
              개인정보처리안내
            </p>
            <p className="text-sm cursor-pointer hover:text-white transition-colors" style={{ color: "#94A3B8" }}>
              이용안내
